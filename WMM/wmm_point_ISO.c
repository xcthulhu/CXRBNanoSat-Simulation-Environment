...
int main()
{
	...
	WMMtype_MagneticModel *MagneticModels[1], *TimedMagneticModel, *MagneticModel;
	...
	MagneticModels[0] = WMM_AllocateModelMemory(NumTerms);
	...
	WMM_readMagneticModel_ISO(filename, MagneticModels, 1);
